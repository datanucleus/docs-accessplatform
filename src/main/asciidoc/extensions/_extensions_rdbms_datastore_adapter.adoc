...
http://www.datanucleus.org/products/accessplatform/datastores/rdbms.html[large selection]
...
The http://www.datanucleus.org/products/accessplatform/datastores/rdbms.html[RDBMS] page lists 
