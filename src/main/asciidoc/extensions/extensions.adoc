...
This plugin mechanism is useful also from a user viewpoint in that you, the user, could provide plugins that use these extension points and extend the capabilities of DataNucleus.
