...
the generation of identity or field values. DataNucleus provides a http://www.datanucleus.org/products/accessplatform/jdo/value_generation.html[large selection]
