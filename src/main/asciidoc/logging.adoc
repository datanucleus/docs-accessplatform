...
*If you have time to translate our log messages into other languages, please contact one of the developers via the http://forum.datanucleus.org[Online Forum].*
