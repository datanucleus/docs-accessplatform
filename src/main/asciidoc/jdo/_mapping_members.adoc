...
Look at the link:#field_types[Types Guide] and if the type has a tick in the column "Persistent?" then you don't need to mark the _persistence-modifier_ as "persistent".
