...
See also the property name "datanucleus.identifier.case" in the link:persistence.html#persistence_properties.html[Persistence Properties Guide].
|
...
See also the property name "datanucleus.identifier.case" in the link:persistence.html#persistence_properties[Persistence Properties Guide].
|
...
See also "datanucleus.cache.collections" in the link:persistence.html#persistence_properties[Persistence Properties Guide]. 
...
See also "datanucleus.cache.collections.lazy" in the link:persistence.html#persistence_properties[Persistence Properties Guide].
This MetaData attribute is used to override the value used by the _PersistenceManagerFactory_
|*true*, false
