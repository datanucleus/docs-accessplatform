...
* link:#schema_foreign_key[RDBMS : Foreign Keys]
...
With RDBMS you can define the names of some of the foreign keys that are used along relationships.
When you have a join table you can define the foreign key back to the owner and foreign key across to the element like this
