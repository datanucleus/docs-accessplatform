...
If you want to view the object, you can specify the query extension *datanucleus.includeSoftDeletes* as _true_ and the soft-deleted records will be visible.
