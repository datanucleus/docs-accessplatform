...
To read more about *named fetch-groups* and how to use it with link:persistence.html#pm_detach[detach]/link:persistence.html#pm_attach[attach] and you can look at our 
