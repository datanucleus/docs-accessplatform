...
The JDOQueryCache http://www.datanucleus.org/javadocs/api.jdo/latest/org/datanucleus/jdo/JDOQueryCache.html[image:../images/javadoc.png[Javadoc]] has more options available should you need them.
