...
subclasses. If you want to override this and NOT have a discriminator restriction imposed in the SQL then you provide the query extension *dont-restrict-discriminator* set to _true_.
