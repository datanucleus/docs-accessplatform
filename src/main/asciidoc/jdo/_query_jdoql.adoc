...
link:../extensions/extensions.html#query_method_evaluators[DataNucleus extension point]

image:../images/nucleus_extensionpoint.png[]
Please note that you can easily add support for other methods with RDBMS datastore using this 
link:../extensions/extensions.html#rdbms_sql_method[DataNucleus extension point]
