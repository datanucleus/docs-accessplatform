...
NOTE: Whilst the JDO spec only allows you to specify your mapping information using JDO metadata (annotations, or JDO/ORM XML metadata, or JDO Metadata API), 
