...
TIP: A _PersistenceManagerFactory_ is expensive to create so you should create one per datastore for your application and retain it for as long as it is needed.
...
|Type of the StoreManager to use for this PMF. This has typical values of "rdbms", "mongodb".
