...
link:persistence.html#locking_optimistic[optimistic transactions]. 
{true, *false*}
...
See also the link:mapping.html#datastore_identifiers[RDBMS Identifier Guide].
...
Please refer to the link:../datastores/datastores.html#rdbms_statement_batching[Statement Batching guide]
