...
For example, if you want to generate "create" and "drop" (DDL) scripts you can set
---
...
For example, if you want to generate (drop existing, then create) the schema USING your own (DDL) scripts, you can set
---
