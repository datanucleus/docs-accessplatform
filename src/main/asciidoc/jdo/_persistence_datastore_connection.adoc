...
WARN: You *must* return the connection back to the _PersistenceManager_ before performing any _PersistenceManager_ operation. You do this by calling _conn.close()_
