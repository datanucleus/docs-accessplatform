...
[.stretch, cols="a,a",frame="none", options="noheader"]
|===
|*JDO Guides*
...
In addition to the JDO and JPA API support, we also provide a link:rest/rest.html[REST API Guide] icon:file-pdf[link="./rest/rest.pdf"] 
