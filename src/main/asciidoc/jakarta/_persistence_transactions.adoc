...
image:../images/javadoc.png[Javadoc, link=http://www.datanucleus.org/javadocs/jakarta.persistence/2.2/javax/persistence/EntityTransaction.html] from the _EntityManager_,
