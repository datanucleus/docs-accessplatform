...
image:../images/javadoc.png[Javadoc, link=http://www.datanucleus.org/javadocs/jakarta.persistence/3.0/jakarta/persistence/criteria/CriteriaBuilder.html]

For a complete list of all methods available on `CriteriaQuery`, refer to
image:../images/javadoc.png[Javadoc, link=http://www.datanucleus.org/javadocs/jakarta.persistence/3.0/jakarta/persistence/criteria/CriteriaQuery.html]
