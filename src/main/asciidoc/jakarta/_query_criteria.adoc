...
image:../images/javadoc.png[Javadoc, link=http://www.datanucleus.org/javadocs/jakarta.persistence/2.2/javax/persistence/criteria/CriteriaBuilder.html]

For a complete list of all methods available on `CriteriaQuery`, refer to
image:../images/javadoc.png[Javadoc, link=http://www.datanucleus.org/javadocs/jakarta.persistence/2.2/javax/persistence/criteria/CriteriaQuery.html]
