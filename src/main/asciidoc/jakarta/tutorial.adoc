...
image:../images/source_code.png[Source Code, link=https://github.com/datanucleus/samples-jpa/tree/master/tutorial]
...
java -cp target/classes:lib/datanucleus-core.jar:lib/datanucleus-api-jpa.jar:lib/jakarta.persistence.jar
...
* The `jakarta.persistence.jar` (defining the JPA API interface)
...
-----
<properties>
    <property name="jakarta.persistence.jdbc.url" value="mongodb:/nucleus1"/>
    <property name="datanucleus.schema.autoCreateAll" value="true"/>
</properties>
-----
...
Consult the link:persistence.html[JPA Persistence Guide] for the many other properties available for configuring persistence.
...
# Manually on Linux/Unix :
java -cp lib/jakarta.persistence.jar:lib/datanucleus-core.jar:lib/datanucleus-rdbms.jar:lib/datanucleus-api-jpa.jar:lib/{datastore-driver}.jar:target/classes/:. 
