...
NOTE: You cannot have a 1-1 relation to a long/int field! Jakarta Persistence is for use with object-oriented systems, not flat data.
...
NOTE: DataNucleus does not support a 1-1 BIDIRECTIONAL relation using a join table. It is not a use-case that is very common and is not part of the Jakarta Persistence spec. 
