...
If using any of the DataNucleus extensions, then the XSD is http://www.datanucleus.org/xsd/jakarta/orm_3_0.xsd[defined here], in which case you would define your header as :-

[source,xml]
-----
<?xml version="1.0" encoding="UTF-8" ?>

<entity-mappings xmlns="http://www.datanucleus.org/xsd/jakarta/orm"
    xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
    xsi:schemaLocation="http://www.datanucleus.org/xsd/jakarta/orm
        http://www.datanucleus.org/xsd/jakarta/orm_3.0.xsd" version="3.0">
    ...
</entity-mappings>
-----
