...
link:../jdo/tutorial.html[for JDO] and link:../jpa/tutorial.html[for JPA]
...
* This plugin is in prototype stage so would welcome feedback and, better still, some contributions to fully exploit the power of Neo4j. 
Register your interest on https://groups.io/g/datanucleus/[Groups.IO] or https://gitter.im/datanucleus/Lobby[Gitter]
