...
subclasses. If you want to override this and NOT have a discriminator restriction imposed in the SQL then you provide the query hint *dont-restrict-discriminator* set to _true_.
