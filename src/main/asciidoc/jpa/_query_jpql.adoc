...
subclasses. If you want to override this and NOT have a discriminator restriction imposed in the SQL then you provide the query hint *datanucleus.dontRestrictDiscriminator* set to _true_.
