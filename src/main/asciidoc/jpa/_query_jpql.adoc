...
DataNucleus doesn't fully support all usages of this since that primary expression is a Map field, and the Map can equally be represented as a join table,
