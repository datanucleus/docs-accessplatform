...
NOTE: You can represent inheritance of embedded objects but only using _SINGLE_TABLE_ strategy using a discriminator (you must define it in the metadata of the embedded type). 
