...
* *datanucleus-api-jpa.jar* : This is DataNucleus' implementation of the JDO API. It implements the interfaces defined in _javax.persistence.jar_.
...
* *datanucleus-jpa-query.jar* : This provides an _annotation processor_ and is used by the JPA Criteria query mechanism to generate the static metamodel classes used at runtime.
