...
See also link:extensions.html#java_types[the Java Types plugin-point]
You can also define more specific support for it with RDBMS datastores - link:extensions.html#rdbms_java_types[the RDBMS Java Types plugin-point]
...
|icon:check[]
|icon:times[]
|See link:mapping.html#one_to_many_list[the 1-N Lists Guide]
...
|icon:check[]
|icon:times[]
|See link:mapping.html#one_to_many[the 1-N Collections Guide]
...
|icon:check[]
|icon:times[]
|See link:mapping.html#one_to_many_map[the 1-N Maps Guide]
...
|icon:check[]
|icon:times[]
|Persisted as a Map currently. No List-ordering is supported. See link:mapping.html#one_to_many_map[the 1-N Maps Guide]
...
|icon:check[]
|icon:times[]
|Persisted as a Set currently. No List-ordering is supported. See link:mapping.html#one_to_many[the 1-N Collections Guide]
...
|icon:check[]
|icon:times[]
|The comparator is specifiable via the metadata extension _comparator-name_ (see below). See link:mapping.html#one_to_many_list[the 1-N Lists Guide]
...
|icon:check[]
|icon:times[]
|The comparator is specifiable via the metadata extension _comparator-name_ (see below). See link:mapping.html#one_to_many_map[the 1-N Maps Guide]
...
|icon:check[]
|icon:times[]
|The comparator is specifiable via the metadata extension _comparator-name_ (see below). See link:mapping.html#one_to_many[the 1-N Collections Guide]
...
|icon:check[]
|icon:times[]
|Requires *datanucleus-guava* plugin. See link:mapping.html#one_to_many[the 1-N Collections Guide]
|===
