...
See also link:../extensions/extensions.html#java_types[the Java Types extension point].
You can also define more specific support for it with RDBMS datastores - link:../extensions/extensions.html#rdbms_java_mapping[the RDBMS Java Types extension point]
