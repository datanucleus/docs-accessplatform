...
http://www.datanucleus.org/javadocs/javax.persistence/2.2/javax/persistence/EntityTransaction.html[image:../images/javadoc.png[Javadoc]] from the _EntityManager_,
