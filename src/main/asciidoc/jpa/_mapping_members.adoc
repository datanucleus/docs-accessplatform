...
Please note that the field Java type defines whether it is, by default, persistable. Look at the link:types.html[Types Guide] and if the type has a tick in the column
