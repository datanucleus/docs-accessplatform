...
In general you will be performing all operations on a _EntityManager_ within a link:#transactions[transaction], whether your transactions are controlled by your JavaEE container, 
