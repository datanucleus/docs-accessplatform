...
link:../extensions/extensions.html#cache_level2[image:../images/nucleus_extensionpoint.png[]]
The L2 cache is a DataNucleus extension point allowing you to provide your own cache where you require it. Use the examples of the EHCache, Coherence caches etc as reference.
