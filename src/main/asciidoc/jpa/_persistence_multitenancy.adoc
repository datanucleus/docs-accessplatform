...
em2.close();
-----
* Per datastore access : When creating the EMF set the persistence property _datanucleus.tenantProvider_ and set it to an instance of_org.datanucleus.store.schema.MultiTenancyProvider_.
[source,java]
-----
