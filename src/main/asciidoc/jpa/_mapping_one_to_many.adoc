...
Just like in the above example, here we have a Map of simple keys/values. In this case we are wanting to store this Map into a single column in the owning table. 
We do this by using a JPA AttributeConverter.
