...
* RDBMS : link:#connection_pooling_rdbms_dbcp[Apache DBCP v1]
...
This is accessed by specifying the persistence property *datanucleus.connectionPoolingType* to _DBCP_ in your `persistence.xml`.
