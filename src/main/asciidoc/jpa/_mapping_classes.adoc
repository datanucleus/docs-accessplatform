...
NOTE: If defining a method _toString_ in a JPA entity class, be aware that use of a persistable field will cause the load of that field if the object is managed, and the field is not yet loaded.
