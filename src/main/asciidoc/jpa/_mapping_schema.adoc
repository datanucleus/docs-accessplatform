...
* We've defined our class as using "nondurable" identity (`@NonDurableId`). This was mandatory in all versions up to 5.0.7 but
after that is optional and you can use application/datastore identity also.
