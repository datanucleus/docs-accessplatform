...
|Spatial.isClosed(Curve)<br />Spatial.isClosed(MultiCurve)
...
|Spatial.length(Curve)<br />Spatial.length(MultiCurve)
...
|Spatial.centroid(Surface)<br/>centroid(MultiSurface)
...
|Spatial.pointOnSurface(Surface)<br/>pointOnSurface(MultiSurface)
...
|Spatial.area(Surface)<br/>area(MultiSurface)
