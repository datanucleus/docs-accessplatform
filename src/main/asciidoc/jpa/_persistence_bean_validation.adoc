...
*javax.persistence.validation.group.pre-remove_ to fine tune the behaviour (the default is to run validation on pre-persist and pre-update if you don't specify these).
